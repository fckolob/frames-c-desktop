...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE: {
            ...
            const char* series[] = {"s20", "s25", "s25TripleRiel", "s25TresHojasEnDosRieles", "s25ReforzadaTresHojasEnDosRieles", "probbaCorrediza", "probbaCorredizaTripleRiel", "probbaCorredizaTresHojasEnDosRieles", "galaCorredizaTripleRiel", "galaCorredizaCuatroRieles", "galaCorrediza"};
            for(int i=0; i<11; i++) SendMessage(hSerie, CB_ADDSTRING, 0, (LPARAM)series[i]);
